...
- 43 source skills match `manifest.json` exactly.
- One implicit router selects up to four focused downstream skills.
- Six project-derived lanes cover Android/Kotlin, retrieval, storage, Windows-local development, Vue/VitePress, and technical SEO.
